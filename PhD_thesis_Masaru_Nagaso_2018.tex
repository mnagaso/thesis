% this line is required to avoid a creation of error on velification on https://facile.cines.fr.
...
\input{Chapter1_Introduction}  %%%%%%% Chapter 1: Introduction

\cleardoublepage
\input{Chapter2}  %%%%%%% Chapter 2: basic equations and physical description of the problem

\cleardoublepage
\input{Chapter3}  %%%%%%% Chapter 3: SEISMIC_CPML + 2D results of the article with Said

\cleardoublepage
\input{Chapter4}  %%%%%%% Chapter 4: 3D results

\cleardoublepage
\input{Chapter5_Conclusions_in_English}  %%%%%%% Chapter 5: Conclusions in English
